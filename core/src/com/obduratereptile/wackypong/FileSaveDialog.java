...
public class FileSaveDialog extends Dialog implements LevelSelectorListener {
	private WackyPong game;
	private LevelSelector selectFile;
	private TextButton buttonCancel;
	public int selectedFile;
	
	public FileSaveDialog(Skin skin, WackyPong g) {
		super("Save Playing Field", skin, "default");
		this.game = g;
